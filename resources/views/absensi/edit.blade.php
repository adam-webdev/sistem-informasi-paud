        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <select name="absen" class="form-control" required id="absen">
                    <option value="Hadir" {{ $absensi->hadir === 'Hadir' ? 'selected' : '' }}>Hadir</option>
                    <option value="Izin" {{ $absensi->izin === 'Izin' ? 'selected' : '' }}>Izin</option>
                    <option value="Sakit" {{ $absensi->sakit === 'Sakit' ? 'selected' : '' }}>Sakit</option>
                </select>
            </div>
