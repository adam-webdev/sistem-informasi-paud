                    ...
                    <div class="form-group">
                        ...
                        <select name="tahunajaran_id" class="form-control" required id="tahun_ajaran">
                            ...
                            @foreach ($tahunajaran as $tahunajaran)
                                <option value="{{ $tahunajaran->id }}">{{ $tahunajaran->tahun_ajaran }} - semester
                ...
                <tbody>
                    @foreach ($absensi as $absensi)
                        <tr align="center">
                            ...
                            <td>{{ $absensi->hadir === 1 ? $absensi->hadir : '-' }}
                            </td>
                            <td>{{ $absensi->izin === 1 ? $absensi->izin : '-' }}
                            </td>
                            <td>{{ $absensi->sakit === 1 ? $absensi->sakit : '-' }}
                            </td>
                            @hasanyrole('Admin|Guru')
