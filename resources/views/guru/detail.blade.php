...
<div class="modal-body">
    <div class="form-group">
        ...
        <input type="text" name="tempat" value="{{ $guru->nama_lengkap }}" class="form-control" id="tempat"
            readonly>
    </div>
    ...
    <div class="form-group">
        ...
        <img src="/storage/{{ $guru->image }}" alt="guru" style="object-fit:contain" width="150"
            height="150">
    </div>
