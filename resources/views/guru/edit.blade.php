    ...
    <form action="{{ route('guru.update', [$guru->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="no_hp" value="{{ $guru->no_hp }}" class="form-control" id="no_hp" required>
            </div>

            <div class="form-group">
                <label for="foto">Foto :</label><br>
                <img style="object-fit: contain" src="/storage/{{ $guru->image }}" alt="guru" width="150" height="150">
