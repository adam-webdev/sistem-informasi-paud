...
@section('content')
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="ayah" value="{{ $siswa->nama_ayah }}" class="form-control" id="ayah" readonly>
        </div>
        <div class="form-group">
            <label for="ibu">Nama Ibu :</label>
            <input type="text" name="ibu" value="{{ $siswa->nama_ibu }}" class="form-control" id="ibu" readonly>
        </div>

        <div class="form-group">
            <label for="jabatan">Kelas :</label>
            <input type="text" name="kelas" value="{{ $siswa->kelas->nama_kelas }}" class="form-control" id="jabatan"
                readonly>
        </div>
        ...
        <div class="form-group">
            ...
            <img src="/storage/{{ $siswa->image }}" alt="siswa" style="object-fit:contain" width="150" height="150">
        </div>
