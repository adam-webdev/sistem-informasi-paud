...
<form action="{{ route('siswa.update', [$siswa->id]) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nis" value="{{ $siswa->nis }}" class="form-control" id="nis"
                required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="agama" value="{{ $siswa->agama }}" class="form-control" id="agama"
                required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_ayah" value="{{ $siswa->nama_ayah }}" class="form-control"
                id="nama_ibu" required>
        </div>
        <div class="form-group">
            <label for="no_hp">No HP :</label>
            <input type="text" name="no_hp" value="{{ $siswa->no_hp }}" class="form-control" id="no_hp"
                required>
        </div>
        <div class="form-group">
            <label for="foto">Foto :</label><br>
            <img style="object-fit: contain" src="/storage/{{ $siswa->image }}" alt="guru" width="150"
                height="150">
